            ...
            <nav className="fixed bottom-0 left-0 right-0 bg-black/80 backdrop-blur-xl border-t border-white/10 z-50 safe-pb">
                ...
                {showAddButton && onAddRound && (
                    <motion.button
                        ...
                        whileTap={{ scale: 0.9 }}
                        onClick={onAddRound}
                        className="fixed bottom-32 left-1/2 transform -translate-x-1/2 w-16 h-16 bg-gradient-to-r from-[#FF9F1C] to-[#FF4D8D] rounded-full flex items-center justify-center shadow-2xl shadow-[#FF9F1C]/40 z-30"
